	...
	if UnreplacableBitCount() == 7 {
		...
		if OptimizeUnreplacablesEnabled() {
			...
			return tipTestTable{
				{[]byte{0xaa, 0xaa, 0xaa}, []byte{0x01}},                         // Just 1 pattern
				{[]byte{0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa}, []byte{0x01, 0x01}}, // just 2 pattern
				{[]byte{0x33, 0xaa, 0xaa, 0xaa}, []byte{0xc0, 0x01, 0xf3}}, // 1 pattern in the end
				{[]byte{0xaa, 0xaa, 0xaa, 0x37}, []byte{0x01, 0xc0, 0xf7}}, // 1 pattern in front
				{[]byte{0xaa, 0xaa, 0xaa, 0x36, 0x37}, []byte{0x01, 0xc0, 0xf6, 0xf7}}, // 1 pattern in front
				{[]byte{0xaa, 0xaa, 0xaa, 0x35, 0x36, 0x37}, []byte{0x01, 0xc0, 0xf5, 0xf6, 0xf7}}, // 1 pattern in front
				{[]byte{0xaa, 0xaa, 0xaa, 0x34, 0x35, 0x36, 0x37}, []byte{0x01, 0xc0, 0xf4, 0xc0, 0xf5, 0xf6, 0xf7}}, // 1 pattern in front
				{[]byte{0xaa, 0xaa, 0xaa, 0x33, 0x34, 0x35, 0x36, 0x37}, []byte{0x01, 0xc0, 0xf3, 0xf4, 0xc0, 0xf5, 0xf6, 0xf7}}, // 1 pattern in front
				//                          01 ------------------v
				{[]byte{0xaa, 0xaa, 0xaa, 0x43 }, []byte{0x01, 0xc1, 0xc3 }}, // 1 pattern in front
				//                                      00    00    01 -----------------------------------v
				//                          00    00 -----------------------------------v
				{[]byte{0xaa, 0xaa, 0xaa, 0x33, 0x34, 0x35, 0x36, 0x47}, []byte{0x01, 0xc0, 0xf3, 0xf4, 0xc1, 0xf5, 0xf6, 0xc7}}, // 1 pattern in front
				{[]byte{0xaa, 0xaa, 0xaa, 0x33, 0x34, 0x35, 0x36, 0x87}, []byte{0x01, 0xc0, 0xf3, 0xf4, 0xc2, 0xf5, 0xf6, 0xc7}}, // 1 pattern in front
				{[]byte{0xaa, 0xaa, 0xaa, 0x33, 0x34, 0x35, 0x36, 0xc7}, []byte{0x01, 0xc0, 0xf3, 0xf4, 0xc3, 0xf5, 0xf6, 0xc7}}, // 1 pattern in front
				{[]byte{0xaa, 0xaa, 0xaa, 0x33, 0x34, 0x35, 0x36, 0xf7}, []byte{0x01, 0xc0, 0xf3, 0xf4, 0xc3, 0xf5, 0xf6, 0xf7}}, // 1 pattern in front
				//                                      00    00    11 -----------------------------------v
				//                          00    11 -----------------------------------v
				{[]byte{0xaa, 0xaa, 0xaa, 0x33, 0xf4, 0x35, 0x36, 0xf7}, []byte{0x01, 0xc3, 0xf3, 0xf4, 0xc3, 0xf5, 0xf6, 0xf7}}, // 1 pattern in front
				{[]byte{0xaa, 0xaa, 0xaa, 0x33, 0x44, 0x35, 0x86, 0xf7}, []byte{0x01, 0xc1, 0xf3, 0xc4, 0xcb, 0xf5, 0xc6, 0xf7}}, // 1 pattern in front
				{[]byte{0xaa, 0xaa, 0xaa, 0x33, 0x34, 0x35, 0xc6, 0xf7}, []byte{0x01, 0xc0, 0xf3, 0xf4, 0xcf, 0xf5, 0xc6, 0xf7}}, // 1 pattern in front
			}
		}
	}
}
