...
func testTable() tipTestTable {
	if optimizeUnreplacables() {
		return tipTestTable{
			{[]byte{0xaa, 0xaa, 0xaa, 'A', 0xaa, 0xaa, 0xaa}, []byte{0x01, 0x80, 0x01, 0x80 | 'A'}}, // only unreplacable 1 byte, not optimizable because msb==0
			...
			{[]byte{0xf7, 0x77, 0xaa, 0xaa, 0xaa}, []byte{0x82, 0xf7, 0x01, 0xf7}}, // 1 pattern in the end, not optimizable
			{[]byte{0x77, 0xf7, 0xaa, 0xaa, 0xaa}, []byte{0x81, 0xf7, 0x01, 0xf7}}, // 1 pattern in the end, not optimizable

			{[]byte{0xd1, 'A', 0xaa, 0xaa, 0xaa}, []byte{0x82, 0xd1, 0x01, 0x80 | 'A'}}, // 1 pattern in the end, not optimizable
			{[]byte{0xd1, 0xd2, 0xaa, 0xaa, 0xaa}, []byte{0xd1, 0xd2, 0x01}},            // 1 pattern in the end, optimizable

			{[]byte{0xaa, 0xbb}, []byte{0x83, 0xaa, 0xbb}},                                                              // only unreplacable bytes, not optimizable
			...
			{[]byte{0xaa, 0xbb, 0xcc, 0xaa, 0xbb}, []byte{0x9f, 0xaa, 0xbb, 0xcc, 0xaa, 0xbb}},                          // only unreplacable bytes, not optimizable

			{[]byte{0xd1, 0xaa, 0xaa, 0xaa, 0xd2}, []byte{0x83, 0x01, 0xd1, 0xd2}},                                     // 1 pattern in the middle, not optimizable
			{[]byte{0xaa, 0xaa, 0xaa, 0xd1, 0xd2}, []byte{0x01, 0x83, 0xd1, 0xd2}},                                     // 1 pattern at start, not optimizable
			{[]byte{0xaa, 0xaa, 0xaa}, []byte{0x01}},                                                                   // Just 1 pattern
			{[]byte{0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa}, []byte{0x01, 0x01}},                                           // just 2 pattern
			{[]byte{0xd1, 0xaa, 0xaa, 0xaa, 0x72, 0xaa, 0xaa, 0xaa}, []byte{0x82, 0x01, 0xd1, 0x01, 0xf2}},             // 2 pattern with distributed unreplacable bytes, not optimizable
			{[]byte{0xd1, 0xaa, 0xaa, 0xaa, 0xd2, 0xaa, 0xaa, 0xaa}, []byte{0xd1, 0x01, 0xd2, 0x01}},                   // 2 pattern with distributed unreplacable bytes, optimizable
			{[]byte{0xd1, 0xaa, 0xaa, 0xaa, 0xd2, 0xaa, 0xaa, 0xaa, 0xd3}, []byte{0x87, 0x01, 0xd1, 0x01, 0xd2, 0xd3}}, // 2 pattern with distributed unreplacable bytes, not optimizable
		}
